...
#define MY_DEBUG
static const PROGMEM u1_t NWKSKEY[16] = { 0x00, 0x00, 0xA6, 0x47, 0xE0, 0x73, 0x79, 0x80, 0x96, 0x5C, 0x7C, 0x08, 0x32, 0x06, 0x47, 0xAD };
static const u1_t PROGMEM APPSKEY[16] = { 0x00, 0x00, 0x4A, 0x50, 0x04, 0x14, 0x2A, 0x81, 0x16, 0x22, 0x16, 0xA4, 0xAE, 0x87, 0xB0, 0xB3 };
static const u4_t DEVADDR = 0x000010AA ; // <-- Change this address for every node!
